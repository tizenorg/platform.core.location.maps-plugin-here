...
typedef struct _GLData
{
	...
	int x, y, w, h;
	double lat, lng, zoom, angle, tilt;
...
public:
	...
	here_error_e RenderMap(const maps_coordinates_h mapsCoord, const double dZoom, const double dAngle, const double dTilt);
	here_error_e RenderMapByArea(const maps_area_h hArea, const double dZoom, const double dAngle, const double dTilt);
	...
	static here_error_e GetMinTilt(int *nMinTilt);
	static here_error_e GetMaxTilt(int *nMaxTilt);
	static here_error_e OnViewObject(const map_view_object_h object, const map_view_object_operation_e operation);

	here_error_e AddObject(map_view_object_h obj);
	static void RenderingCb(void *data);
	static bool foreachObject(int index, int total, map_view_object_h object, void *user_data);
...
private:
	...
	static void __processViewObject(const map_view_object_h object, const map_view_object_operation_e operation);
