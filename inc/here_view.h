...
public:
	...
	here_error_e Init(map_view_h hView, maps_plugin_map_view_ready_cb pCbFunc);
	...
	here_error_e ScreenToGeolocation(const int x, const int y, maps_coordinates_h *mapsCoord);
