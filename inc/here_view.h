...
public:
	...
	here_error_e Init(const map_view_h hView, maps_plugin_map_view_ready_cb pCbFunc);
	...
	static here_error_e OnViewObject(const map_object_h object, map_object_operation_e operation);
...
private:
	...
	static void __processViewObject(const map_object_h object, map_object_operation_e operation);
	void __setMapType();
